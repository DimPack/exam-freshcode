...
db['Users'].hasMany(db['Message'], { foreignKey: 'senderId', targetKey: 'id' });
db['Message'].belongsTo(db['Users'], { foreignKey: 'senderId', targetKey: 'id' });

db['Conversation'].hasMany(db['Message'], { foreignKey: 'conversationId', targetKey: 'id' });
